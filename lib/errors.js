import {either, path, prop} from 'ramda'
import {parseError, parseStatus, parseStatusText} from './requests'
...
export class ResponseError extends BaseError {
    constructor(res = {}) {
        ...
        super(status, statusText, either(prop('data'), path(['response', 'data']))(res))
    }
}
